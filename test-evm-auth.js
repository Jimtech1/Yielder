...
async function testEvmAuth() {
  try {
    // 1. Generate Random EVM Wallet
    const wallet = ethers.Wallet.createRandom();
    const address = wallet.address;
    console.log(`🔑 Generated EVM Address: ${address}`);
    ...
    // 3. Sign Challenge
    // Ethers wallet.signMessage automatically adds the prefix
